...
# Reflection:
# Comprehensions felt faster to write because they use fewer lines.
# They are easy to read for simple operations, but loops may be
# easier to understand when the logic becomes more complex.
...
#           if x + y > 5]
#
# In this situation, regular nested loops would be easier to read
# and maintain.
